...
$routes = [
    ...
    ["name" => "admin_locations_paginator", "url" => "/admin/location/{page}/{amount}", "controller" => [new AdminLocationsController(), 'paginator'], "method" => "GET"],
    ...
    ["name" => "admin_locations_single", "url" => "/admin/location/update/{id}", "controller" => [new AdminLocationsController(), 'show'], "method" => "GET"],
    ["name" => "admin_locations_update", "url" => "/admin/location/update/{id}", "controller" => [new AdminLocationsController(), 'update'], "method" => "POST"],
    ["name" => "admin_locations_update", "url" => "/admin/location/delete/{id}", "controller" => [new AdminLocationsController(), 'delete'], "method" => "POST"],
